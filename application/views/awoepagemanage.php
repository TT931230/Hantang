...
<div class="hpm-content">
    <div class="managepagetitle">问鼎世界管理</div>
    <div class="hpm-div">
        <label class="col-lg-2">所属页面</label>
        <div class="col-lg-2">问鼎世界</div>
    </div>
    ...
    <div class="hpm-div">
        ...
        <select  id="affiliatedmoudle" class="selectpicker bla bla bli"  data-live-search="true">
            {affiliatedmodules}
    ...
    <div class="hpm-save">
        <button class="btn btn-default" onclick="$savepageimg('awoe')">保存</button>
    </div>
</div>
...
<div class="hpm-footer">
    <table>
        <tr>
            ...
            <td class="hpm-td5">
                <a href="javascript:;" onclick="$savehpmselected('awoe')" class="cl-imgeditbtn">保存所选</a>
            </td>
            <td class="hpm-td6">
                <a href="javascript:;" onclick="$delhpmselected('awoe')" class="cl-imgeditbtn">删除所选</a>
            </td>
        </tr>
        {relatedimg}
        <tr>
            ...
            <td id="{source_id}_edit1" class="hpm-td5">
                <a href="javascript:;" onclick="$savhpmsingleimg('{source_id}','awoe') " class="cl-imgeditbtn">保存</a>
            </td>
            <td id="{source_id}_edit2" class="hpm-td6">
                <a href="javascript:;" onclick="$delhpmsingleimg('{source_id}','awoe')" class="cl-imgeditbtn">删除</a>
            </td>
        </tr>
        {/relatedimg}
    </table>
