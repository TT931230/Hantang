        ...
        <div class="footerarea">
            <div class="footerleftdiv1">
                ...
                <div class="footerdetials">
                    <div class="footerdetail" style="width: 90px;margin-left: 40px;">
                        <a href="javascript:;">
                            <span class="footerlogos" data-toggle="modal" data-target="#weixinModal">
                                 <img src="{weixin}" alt="">
                            </span></a>WeChat
                    </div>
                    <div class="footerdetail" style=" width: 90px;margin-left: 36px;">
            ...
            <div class="footerleftdiv4">
                ...
                <div id="footer_4" class="footerdetials4">
                    ...
                    <div class="footerdetail4" style="width: 136px;">
