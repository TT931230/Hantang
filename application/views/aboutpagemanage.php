...
<div class="hpm-content">
    <div class="managepagetitle">关于汉唐管理</div>
    <div class="hpm-div">
        <label class="col-lg-2">所属页面</label>
        <div class="col-lg-2">关于汉唐</div>
    </div>
    ...
    <div class="hpm-save">
        <button class="btn btn-default" onclick="$savepageimg('about')">保存</button>
    </div>
</div>
...
<div class="hpm-footer">
    <table>
        <tr>
            ...
            <td class="hpm-td6">
                <a href="javascript:;" onclick="$delhpmselected('about')" class="cl-imgeditbtn">删除所选</a>
            </td>
        </tr>
        {relatedimg}
        <tr>
            ...
            <td id="{source_id}_edit2" class="hpm-td6">
                <a href="javascript:;" onclick="$delhpmsingleimg('{source_id}','about')" class="cl-imgeditbtn">删除</a>
            </td>
        </tr>
        {/relatedimg}
    </table>
