...
<div class="hpm-footer">
    <table>
        <tr>
            ...
            <td class="hpm-td5">
                <a href="javascript:;" onclick="$savehpmselected('platform')" class="cl-imgeditbtn">保存所选</a>
            </td>
            <td class="hpm-td6">
                <a href="javascript:;" onclick="$delhpmselected('platform')" class="cl-imgeditbtn">删除所选</a>
            </td>
        </tr>
        {relatedimg}
        <tr>
            ...
            <td id="{source_id}_edit1" class="hpm-td5">
                <a href="javascript:;" onclick="$savhpmsingleimg('{source_id}','platform') " class="cl-imgeditbtn">保存</a>
            </td>
            <td id="{source_id}_edit2" class="hpm-td6">
                <a href="javascript:;" onclick="$delhpmsingleimg('{source_id}','platform')" class="cl-imgeditbtn">删除</a>
            </td>
        </tr>
        {/relatedimg}
    </table>
